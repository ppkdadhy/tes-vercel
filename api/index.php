...
// 1. TANGANI ASSETS KAIADMIN DI DALAM PROJECT-CRUD
...
// 2. TANGANI ASSETS STATIS PUBLIC
...
// 3. ROUTING KE FILE PHP DI PROJECT-CRUD
				...
				<div class="slider-item ">
					...
					<div class="container">
						<div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
							<div class="one-third js-fullheight order-md-last img" style="background-image:url(/img/<?php echo $slider['image'] ?>);">
								<div class="overlay"></div>
							</div>
							<div class="one-forth d-flex  align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
								<div class="text">
									<span class="subheading">Hello!</span>
									<h1 class="mb-4 mt-3"><?= $title[0] ?> <span><?= $title[1] ?></span></h1>
									<h2 class="mb-4"><?= $hasil ?></h2>
									<p><a href="<?= $slider['button1_link'] ?>" target="_blank" class="btn btn-primary py-3 px-4"><?= $slider['button1_text'] ?></a> <a href="<?= $slider['button2_link'] ?>" target="_blank" class="btn btn-white btn-outline-white py-3 px-4"><?= $slider['button2_text'] ?></a></p>
								</div>
							</div>
						</div>
					</div>
